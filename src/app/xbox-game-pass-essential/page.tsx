...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: plan.seo.title,
    description: plan.seo.description,
    url: 'https://activeplay.games/xbox-game-pass-essential',
    type: 'website',
    siteName: 'ActivePlay',
    locale: 'ru_RU',
    images: [{ url: '/images/platforms/xbox.png', width: 1200, height: 630, alt: 'Xbox Game Pass Essential — купить в России' }],
  },
  twitter: {
  ...
  alternates: { canonical: 'https://activeplay.games/xbox-game-pass-essential' },
};

const productSchema = {
  '@context': 'https://schema.org',
  '@type': 'Product',
  name: 'Xbox Game Pass Essential — купить в России',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 2, name: 'Game Pass Essential', item: 'https://activeplay.games/xbox-game-pass-essential' },
  ],
};

export default function GamePassEssentialPage() {
  return (
    <>
      ...
      <main className="relative z-10">
        <GamePassSubscriptionPage subscriptionId="essential" />
      </main>
      <Footer />
    </>
  );
