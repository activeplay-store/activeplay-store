  ...
  return (
    <>
      <main className="relative z-10">
        ...
        {/* JSON-LD */}
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ '@context': 'https://schema.org', '@type': 'FAQPage', mainEntity: eaPlayFaq.map(i => ({ '@type': 'Question', name: i.question, acceptedAnswer: { '@type': 'Answer', text: i.shortAnswer } })) }) }} />
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ '@context': 'https://schema.org', '@type': 'Product', name: 'EA Play', brand: { '@type': 'Brand', name: 'Electronic Arts' }, offers: [{ '@type': 'Offer', name: 'EA Play 12 мес (Украина)', priceCurrency: 'RUB', price: '3000', availability: 'https://schema.org/InStock' }, { '@type': 'Offer', name: 'EA Play Pro 12 мес (ПК)', priceCurrency: 'RUB', price: '12500', availability: 'https://schema.org/InStock' }] }) }} />
