    ...
    <>
      ...
      <article className="min-h-screen bg-[#0A1628]">
        ...
        <div className="max-w-3xl mx-auto px-8 pt-20 pb-20">
          ...
          <p className="text-[17px] text-[#9aa8b8] leading-relaxed">
            Сколько будет стоить GTA 6 для россиян? Самый дешёвый вариант &mdash; цифровая покупка через <strong className="text-white">турецкий аккаунт PS Store</strong>. При ожидаемой цене ~{'\u20BA'}2 500 и текущем курсе это порядка 6 750{'\u2013'}8 100 {'\u20BD'} через подарочные карты PSN.
          </p>
