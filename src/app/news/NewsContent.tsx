          ...
          {visible.map((item) => (
            <ScrollReveal key={item.id}>
              <a
                ...
                className="group block rounded-xl border border-transparent bg-white/[0.03] backdrop-blur-sm overflow-hidden transition-all duration-300 hover:border-[#00D4FF]/40 hover:shadow-[0_0_20px_rgba(0,212,255,0.08)] hover:-translate-y-0.5"
              >
                {/* Cover */}
