...
// Обновлено: 2026-03-29T13:18:43.452Z
...
export const newsData: NewsItem[] = [
  {
    id: 'news-1774789261704-22n8',
    slug: 'patch-1-01-00-dlya-crimson-desert-osnovnye-izmeneniya',
    category: 'news' as NewsCategory,
    title: 'Патч 1.01.00 для Crimson Desert: основные изменения',
    excerpt: 'Вышло обновление 1.01.00 для Crimson Desert на PC. Разработчики добавили пять новых легендарных маунтов, доступных после выполнения определенных условий. 

Преступления теперь не влияют на репутацию у',
    content: `<p>Вышло обновление 1.01.00 для Crimson Desert на PC. Разработчики добавили пять новых легендарных маунтов, доступных после выполнения определенных условий.</p>
<p>Преступления теперь не влияют на репутацию у фракций, если вас не поймали. Добавили предмет "Refinement Token": он позволяет улучшить экипировку до 4-го уровня без дополнительных ресурсов. Появилась функция "Make Now" для быстрого крафта блюд и предметов.</p>
<p>Также добавлена функция быстрого перемещения всех выбранных предметов со склада. Разработчики обещают выпустить патч и на других платформах в ближайшее время.</p>`,
    coverUrl: '/images/news/news-1774789261704-22n8.jpg',
    date: '2026-03-29T13:18:43.452Z',
    source: 'Destructoid',
    author: 'ActivePlay',
    tags: ["Crimson Desert","патч","обновление","маунты"],
    metaDescription: 'Crimson Desert получила крупное обновление 1.01.00 на PC. Разработчики добавили новых маунтов, упростили прокачку и исправили ошибки.',
  },
  {
