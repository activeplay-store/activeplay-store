...
{    id: 'news-crimson-desert-patch-101',    slug: 'crimson-desert-patch-1-01-00',    category: 'news' as NewsCategory,    title: 'Crimson Desert: вышел патч 1.01.00 с новыми маунтами и улучшениями',    excerpt: 'Для Crimson Desert вышло обновление 1.01.00 на ПК. Добавили пять новых легендарных маунтов, Жетон улучшений, быстрый крафт и упрощённое хранение предметов.',    content: `<p>Для Crimson Desert вышло обновление 1.01.00 на ПК. Главное: добавили пять новых легендарных маунтов, доступных после выполнения определённых условий. Появился «Жетон улучшения» — с ним можно улучшить экипировку до 4-й стадии без дополнительных ресурсов.</p><p>Разработчики добавили функцию быстрого крафта. Она позволяет мгновенно создавать еду и предметы по изученным рецептам. Также упростили хранение предметов — теперь можно переместить всё из инвентаря в личный сундук одной кнопкой.</p><p>Ещё один важный момент: преступления теперь не снижают уровень вклада фракции, если вас не поймали. Патч бесплатный для всех владельцев игры. Crimson Desert продолжает активно развиваться — Pearl Abyss выпускает обновления регулярно.</p>`,    coverUrl: '/images/covers/crimson-desert.jpg',    date: '2026-03-29',    source: 'Destructoid',    author: 'ActivePlay',    tags: ["Crimson Desert", "патч", "обновление", "PC", "Pearl Abyss"],    metaDescription: 'Crimson Desert получил патч 1.01.00 — новые маунты, быстрый крафт и улучшения качества жизни.',  },
  {
