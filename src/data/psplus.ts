  ...
  extra: {
    ...
    showcaseGames: {
      ...
      newReleases: {
        month: 'Апрель 2026',
        games: [
          { title: "Football Manager 26 Console", image: '/images/covers/football-manager-26-console.jpg' },
          { title: "Horizon Zero Dawn Complete Edition", image: '/images/covers/horizon-zero-dawn-complete-edition.jpg' },
          { title: "Red Dead Redemption 2", image: '/images/covers/red-dead-redemption-2.jpg' },
          { title: "RoboCop: Rogue City", image: '/images/covers/robocop-rogue-city.jpg' },
        ],
      },
    },
    seo: {
